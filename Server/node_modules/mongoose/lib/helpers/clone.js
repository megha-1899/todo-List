...
const Decimal = require('mongoose/lib/types/decimal128');
...
const isMongooseArray = require('mongoose/lib/types/array/isMongooseArray').isMongooseArray;
const isObject = require('mongoose/lib/helpers/isObject');
const isPOJO = require('mongoose/lib/helpers/isPOJO');
const symbols = require('mongoose/lib/helpers/symbols');
const trustedSymbol = require('mongoose/lib/helpers/query/trusted').trustedSymbol;
